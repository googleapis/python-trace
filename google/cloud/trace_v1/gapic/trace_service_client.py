...
class TraceServiceClient(object):
    ...
    def patch_traces(
        ...
        if 'patch_traces' not in self._inner_api_calls:
            self._inner_api_calls['patch_traces'] = google.api_core.gapic_v1.method.wrap_method(
        ...
        self._inner_api_calls['patch_traces'](request, retry=retry, timeout=timeout, metadata=metadata)
    ...
    def list_traces(
        ...
        if 'list_traces' not in self._inner_api_calls:
            self._inner_api_calls['list_traces'] = google.api_core.gapic_v1.method.wrap_method(
        ...
        iterator = google.api_core.page_iterator.GRPCIterator(
            client=None,
            method=functools.partial(self._inner_api_calls['list_traces'], retry=retry, timeout=timeout, metadata=metadata),
            request=request,
            items_field='traces',
    ...
    def get_trace(
        ...
        if 'get_trace' not in self._inner_api_calls:
            self._inner_api_calls['get_trace'] = google.api_core.gapic_v1.method.wrap_method(
        ...
        return self._inner_api_calls['get_trace'](request, retry=retry, timeout=timeout, metadata=metadata)
