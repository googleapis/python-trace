...
from google.cloud.trace_v1.proto import trace_pb2 as google_dot_cloud_dot_devtools_dot_cloudtrace__v1_dot_proto_dot_trace__pb2
...
class TraceService(object):
    ...
    def ListTraces(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/google.devtools.cloudtrace.v1.TraceService/ListTraces',
            google_dot_cloud_dot_devtools_dot_cloudtrace__v1_dot_proto_dot_trace__pb2.ListTracesRequest.SerializeToString,
            google_dot_cloud_dot_devtools_dot_cloudtrace__v1_dot_proto_dot_trace__pb2.ListTracesResponse.FromString,
    ...
    def GetTrace(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/google.devtools.cloudtrace.v1.TraceService/GetTrace',
            google_dot_cloud_dot_devtools_dot_cloudtrace__v1_dot_proto_dot_trace__pb2.GetTraceRequest.SerializeToString,
            google_dot_cloud_dot_devtools_dot_cloudtrace__v1_dot_proto_dot_trace__pb2.Trace.FromString,
            options, channel_credentials,
            call_credentials, compression, wait_for_ready, timeout, metadata)

    @staticmethod
    def PatchTraces(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/google.devtools.cloudtrace.v1.TraceService/PatchTraces',
            google_dot_cloud_dot_devtools_dot_cloudtrace__v1_dot_proto_dot_trace__pb2.PatchTracesRequest.SerializeToString,
