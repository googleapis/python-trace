...
class TraceServiceAsyncClient:
    ...
    async def list_traces(
        ...
        *,
        ...
        Args:
            request (:class:`google.devtools.cloudtrace_v1.types.ListTracesRequest`):
        ...
        Returns:
            google.devtools.cloudtrace_v1.services.trace_service.pagers.ListTracesAsyncPager:
    ...
    async def get_trace(
        ...
        *,
        ...
        Args:
            request (:class:`google.devtools.cloudtrace_v1.types.GetTraceRequest`):
                The request object. The request message for the
                `GetTrace` method.
            project_id (:class:`str`):
                Required. ID of the Cloud project
        ...
        Returns:
            google.devtools.cloudtrace_v1.types.Trace:
    ...
    async def patch_traces(
        ...
        *,
        ...
        Args:
            request (:class:`google.devtools.cloudtrace_v1.types.PatchTracesRequest`):
                The request object. The request message for the
                `PatchTraces` method.
            project_id (:class:`str`):
                Required. ID of the Cloud project
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            traces (:class:`google.devtools.cloudtrace_v1.types.Traces`):
