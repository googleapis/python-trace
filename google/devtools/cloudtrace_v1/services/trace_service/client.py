...
class TraceServiceClient(metaclass=TraceServiceClientMeta):
    ...
    def list_traces(
        ...
        *,
        ...
        Returns:
            google.devtools.cloudtrace_v1.services.trace_service.pagers.ListTracesPager:
    ...
    def get_trace(
        ...
        *,
        ...
        Args:
            request (google.devtools.cloudtrace_v1.types.GetTraceRequest):
                The request object. The request message for the
                `GetTrace` method.
            project_id (str):
                Required. ID of the Cloud project
    ...
    def patch_traces(
        ...
        *,
        ...
        Args:
            request (google.devtools.cloudtrace_v1.types.PatchTracesRequest):
                The request object. The request message for the
                `PatchTraces` method.
            project_id (str):
                Required. ID of the Cloud project
