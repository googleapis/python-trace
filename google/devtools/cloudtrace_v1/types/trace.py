...
class Trace(proto.Message):
    ...
    Attributes:
        ...
        spans (Sequence[google.devtools.cloudtrace_v1.types.TraceSpan]):
...
class Traces(proto.Message):
    ...
    Attributes:
        traces (Sequence[google.devtools.cloudtrace_v1.types.Trace]):
            List of traces.
    """
...
class TraceSpan(proto.Message):
    ...
    Attributes:
        span_id (int):
            ...
            ``2205310701640571284``.
        kind (google.devtools.cloudtrace_v1.types.TraceSpan.SpanKind):
        ...
        labels (Sequence[google.devtools.cloudtrace_v1.types.TraceSpan.LabelsEntry]):
...
class ListTracesRequest(proto.Message):
    ...
    Attributes:
        project_id (str):
            ...
            trace data is stored.
        view (google.devtools.cloudtrace_v1.types.ListTracesRequest.ViewType):
...
class PatchTracesRequest(proto.Message):
    ...
    Attributes:
        project_id (str):
            Required. ID of the Cloud project where the
            trace data is stored.
        traces (google.devtools.cloudtrace_v1.types.Traces):
