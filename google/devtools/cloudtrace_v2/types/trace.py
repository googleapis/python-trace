...
class Span(proto.Message):
    ...
    Attributes:
        ...
        display_name (google.devtools.cloudtrace_v2.types.TruncatableString):
        ...
        attributes (google.devtools.cloudtrace_v2.types.Span.Attributes):
            A set of attributes on the span. You can have
            up to 32 attributes per span.
        stack_trace (google.devtools.cloudtrace_v2.types.StackTrace):
            Stack trace captured at the start of the
            span.
        time_events (google.devtools.cloudtrace_v2.types.Span.TimeEvents):
            A set of time events. You can have up to 32
            annotations and 128 message events per span.
        links (google.devtools.cloudtrace_v2.types.Span.Links):
        ...
        child_span_count (google.protobuf.wrappers_pb2.Int32Value):
            ...
            spans.
        span_kind (google.devtools.cloudtrace_v2.types.Span.SpanKind):
    ...
    class Attributes(proto.Message):
        ...
        Attributes:
            attribute_map (Sequence[google.devtools.cloudtrace_v2.types.Span.Attributes.AttributeMapEntry]):
    ...
    class TimeEvent(proto.Message):
        ...
        Attributes:
            time (google.protobuf.timestamp_pb2.Timestamp):
                ...
                occurred.
            annotation (google.devtools.cloudtrace_v2.types.Span.TimeEvent.Annotation):
                Text annotation with a set of attributes.
            message_event (google.devtools.cloudtrace_v2.types.Span.TimeEvent.MessageEvent):
        ...
        class Annotation(proto.Message):
            ...
            Attributes:
                description (google.devtools.cloudtrace_v2.types.TruncatableString):
        ...
        class MessageEvent(proto.Message):
            ...
            Attributes:
                type_ (google.devtools.cloudtrace_v2.types.Span.TimeEvent.MessageEvent.Type):
    ...
    class TimeEvents(proto.Message):
        ...
        Attributes:
            time_event (Sequence[google.devtools.cloudtrace_v2.types.Span.TimeEvent]):
    ...
    class Link(proto.Message):
        ...
        Attributes:
            ...
            type_ (google.devtools.cloudtrace_v2.types.Span.Link.Type):
    ...
    class Links(proto.Message):
        ...
        Attributes:
            link (Sequence[google.devtools.cloudtrace_v2.types.Span.Link]):
...
class AttributeValue(proto.Message):
    ...
    Attributes:
        string_value (google.devtools.cloudtrace_v2.types.TruncatableString):
...
class StackTrace(proto.Message):
    ...
    Attributes:
        stack_frames (google.devtools.cloudtrace_v2.types.StackTrace.StackFrames):
    ...
    class StackFrame(proto.Message):
        ...
        Attributes:
            ...
            load_module (google.devtools.cloudtrace_v2.types.Module):
                The binary module from where the code was
                loaded.
            source_version (google.devtools.cloudtrace_v2.types.TruncatableString):
    ...
    class StackFrames(proto.Message):
        ...
        Attributes:
            frame (Sequence[google.devtools.cloudtrace_v2.types.StackTrace.StackFrame]):
...
class Module(proto.Message):
    ...
    Attributes:
        module (google.devtools.cloudtrace_v2.types.TruncatableString):
            For example: main binary, kernel modules, and
            dynamic libraries such as libc.so, sharedlib.so
            (up to 256 bytes).
        build_id (google.devtools.cloudtrace_v2.types.TruncatableString):
