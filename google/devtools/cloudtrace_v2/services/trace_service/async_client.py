...
class TraceServiceAsyncClient:
    ...
    async def batch_write_spans(
        ...
        *,
        ...
        Args:
            request (:class:`google.devtools.cloudtrace_v2.types.BatchWriteSpansRequest`):
            ...
            name (:class:`str`):
                ...
                should not be set.
            spans (:class:`Sequence[google.devtools.cloudtrace_v2.types.Span]`):
    ...
    async def create_span(
        ...
        *,
        ...
        Args:
            request (:class:`google.devtools.cloudtrace_v2.types.Span`):
