...
class cloudtraceCallTransformer(cst.CSTTransformer):
...
def fix_files(
    ...
    *,
    transformer=cloudtraceCallTransformer(),
):
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(
        description="""Fix up source that uses the cloudtrace client library.
