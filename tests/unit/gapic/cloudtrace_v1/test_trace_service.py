...
from google.devtools.cloudtrace_v1.services.trace_service import TraceServiceAsyncClient
from google.devtools.cloudtrace_v1.services.trace_service import TraceServiceClient
from google.devtools.cloudtrace_v1.services.trace_service import pagers
from google.devtools.cloudtrace_v1.services.trace_service import transports
...
def test_trace_service_client_client_options_from_dict():
    with mock.patch(
        "google.devtools.cloudtrace_v1.services.trace_service.transports.TraceServiceGrpcTransport.__init__"
    ) as grpc_transport:
...
def test_trace_service_base_transport():
    ...
    with mock.patch(
        "google.devtools.cloudtrace_v1.services.trace_service.transports.TraceServiceTransport.__init__"
    ) as Transport:
...
def test_trace_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(
        ...
        "google.devtools.cloudtrace_v1.services.trace_service.transports.TraceServiceTransport._prep_wrapped_messages"
    ) as Transport:
        Transport.return_value = None
