...
class TestTraceServiceClient(object):
    ...
    def test_patch_traces(self):
        ...
        expected_request = trace_pb2.PatchTracesRequest(project_id=project_id, traces=traces)
    ...
    def test_get_trace(self):
        ...
        assert len(channel.requests) == 1
        expected_request = trace_pb2.GetTraceRequest(project_id=project_id, trace_id=trace_id)
        actual_request = channel.requests[0][1]
        assert expected_request == actual_request
